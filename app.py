...
products_data = [
    ...
    {'id': 13, 'name': '에어커튼 실외용 1000', 'original_price': 22900, 'price': 19900, 'description': '자연 유래 성분으로 안심 설거지', 'image_url': '/static/images/product_air_curtain_out_1000.jpg', 'category': 'air_curtain'},
]
